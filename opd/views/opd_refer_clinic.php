	...
	<div class="row" style="margin-top:55px;">
	  ...
	  <div class="col-md-10 " >
		...
		?>
			...
			<div class="panel panel-default"  style="padding:2px;margin-bottom:1px;" >
				<div class="panel-heading" ><b>Refering Clinic Information</b></div>
					<?php
						echo '<form action="'.site_url("opd/save_refer_clinic").'" method="POST">';
							echo '<table class="table table-condensed"  style="font-size:0.95em;margin-bottom:0px;">';
								echo '<tr>';
									echo '<td>';
										echo 'Date & Time of Visit: <input type="text" readonly class="form-control input-sm" style="width:150px;" name ="AdmissionDate" value="'.date("Y-m-d H:i:s").'">';
									echo '</td>';
									echo '<td>';
								...
								echo 'Clinic: <select type="text"  class="form-control input-sm" style="width:150px;"  name ="Clinic">';
											echo '<option></option>';
											for ($i=0; $i<count($clinic_list); ++$i){
												
												echo '<option value="'.$clinic_list[$i]["clinic_id"].'" ';

												echo ' >'.$clinic_list[$i]["name"]."</option>";
											}											
										echo '</select>';
									...
									echo '<td colspan=2>';
										echo 'Remarks';
										echo '<textarea class="form-control input-sm" id="Remarks" name="Remarks" ></textarea>';
									echo '</td>';
									echo '</tr>';
								...
								echo '</tr>';				
							echo '</table><br>';
							echo '<button type="submit" class="btn btn-primary btn-lg btn-block">Refer to Clinic</button>';
						echo '</form>';
					?>
			</div>	<!-- END OPD INFO-->			
		</div>
